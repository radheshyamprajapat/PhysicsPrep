window.QuestionEngine = (() => {
  const data = [
    ...(Array.isArray(window.PHYSICS_QUESTIONS_1D_POTENTIAL) ? window.PHYSICS_QUESTIONS_1D_POTENTIAL : []),
    ...(Array.isArray(window.PHYSICS_QUESTIONS_NUCLEAR) ? window.PHYSICS_QUESTIONS_NUCLEAR : [])
  ];
